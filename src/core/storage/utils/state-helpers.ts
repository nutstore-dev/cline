...
export async function readStateFromDisk(context: ExtensionContext) {
	...
	const [
		...
		context.secrets.get("nutstoreAccessToken") as Promise<string | undefined>,
	...
	const planModeNutstoreModelId = context.globalState.get("planModeNutstoreModelId") as string | undefined
	const planModeNutstoreModelInfo = context.globalState.get("planModeNutstoreModelInfo") as ModelInfo | undefined
	...
	const actModeNutstoreModelId = context.globalState.get("actModeNutstoreModelId") as string | undefined
	const actModeNutstoreModelInfo = context.globalState.get("actModeNutstoreModelInfo") as ModelInfo | undefined
