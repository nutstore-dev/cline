		...
		switch (message.type) {
			case "say":
				switch (message.say) {
					...
					case "error":
						return <ErrorRow errorType="error" message={message} onOpenModelSelector={onOpenModelSelector} />
					case "diff_error":
						return <ErrorRow errorType="diff_error" message={message} onOpenModelSelector={onOpenModelSelector} />
					case "clineignore_error":
						return (
							<ErrorRow errorType="clineignore_error" message={message} onOpenModelSelector={onOpenModelSelector} />
						)
