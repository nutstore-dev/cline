...
export class CacheService {
	...
	private constructApiConfigurationFromCache(): ApiConfiguration {
		return {
			...
			nutstoreAccessToken: this.secretsCache.get("nutstoreAccessToken"),
			...
			planModeNutstoreModelId: this.globalStateCache.get("planModeNutstoreModelId"),
			planModeNutstoreModelInfo: this.globalStateCache.get("planModeNutstoreModelInfo"),
			...
			actModeNutstoreModelId: this.globalStateCache.get("actModeNutstoreModelId"),
			actModeNutstoreModelInfo: this.globalStateCache.get("actModeNutstoreModelInfo"),
