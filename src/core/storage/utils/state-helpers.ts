...
export async function readSecretsFromDisk(context: ExtensionContext): Promise<Secrets> {
	const [
		...
		context.secrets.get("nutstoreAccessToken") as Promise<Secrets["nutstoreAccessToken"]>,
...
export async function readGlobalStateFromDisk(context: ExtensionContext): Promise<GlobalStateAndSettings> {
	try {
		...
		const planModeNutstoreModelId =
			context.globalState.get<GlobalStateAndSettings["planModeNutstoreModelId"]>("planModeNutstoreModelId")
		const planModeNutstoreModelInfo =
			context.globalState.get<GlobalStateAndSettings["planModeNutstoreModelInfo"]>("planModeNutstoreModelInfo")
