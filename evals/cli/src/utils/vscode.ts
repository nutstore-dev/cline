...
`,
	...
	const settings = {
		...
		"workbench.view.extension.jianguoyun.cline-ActivityBar.visible": true,
	...
	const keybindings = [
		{
			key: "alt+c",
			command: "workbench.view.extension.jianguoyun.cline-ActivityBar",
			when: "viewContainer.workbench.view.extension.jianguoyun.cline-ActivityBar.enabled",
		},
		{
			key: "alt+shift+c",
	...
	const args = [
		...
		"--command",
		"workbench.view.extension.jianguoyun.cline-ActivityBar",
	...
	const startupScript = `
		...
		setTimeout(() => {
			...
			require('vscode').commands.executeCommand('workbench.view.extension.jianguoyun.cline-ActivityBar');
			...
			function activate(context) {
				...
				let disposable = vscode.commands.registerCommand('cline-activator.activate', async function () {
					try {
						...
						const extension = vscode.extensions.getExtension('jianguoyun.cline');
						if (!extension) {
						...
						await vscode.commands.executeCommand('workbench.view.extension.jianguoyun.cline-ActivityBar');
