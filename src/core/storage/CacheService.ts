...
export class CacheService {
	...
	private constructApiConfigurationFromCache(): ApiConfiguration {
		return {
			...
			planModeNutstoreModelId: this.globalStateCache["planModeNutstoreModelId"],
			planModeNutstoreModelInfo: this.globalStateCache["planModeNutstoreModelInfo"],
			...
			actModeNutstoreModelId: this.globalStateCache["actModeNutstoreModelId"],
			actModeNutstoreModelInfo: this.globalStateCache["actModeNutstoreModelInfo"],
