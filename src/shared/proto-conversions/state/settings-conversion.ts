...
export function convertApiConfigurationToProtoApiConfiguration(config: ApiConfiguration): ProtoApiConfiguration {
	return ProtoApiConfiguration.create({
		...
		planModeOpenrouterModelInfo: config.planModeOpenRouterModelInfo
			...
			: undefined,
		planModeNutstoreModelId: config.planModeNutstoreModelId,
		planModeNutstoreModelInfo: config.planModeNutstoreModelInfo
			? JSON.stringify(config.planModeNutstoreModelInfo)
			: undefined,
		...
		actModeOpenrouterModelInfo: config.actModeOpenRouterModelInfo
			...
			: undefined,
		actModeNutstoreModelId: config.actModeNutstoreModelId,
		actModeNutstoreModelInfo: config.actModeNutstoreModelInfo ? JSON.stringify(config.actModeNutstoreModelInfo) : undefined,
...
export function convertProtoApiConfigurationToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	const config: ApiConfiguration = {
		...
		planModeNutstoreModelId: protoConfig.planModeNutstoreModelId,
		...
		actModeNutstoreModelId: protoConfig.actModeNutstoreModelId,
	...
	try {
		...
		if (protoConfig.planModeNutstoreModelInfo) {
			config.planModeNutstoreModelInfo = JSON.parse(protoConfig.planModeNutstoreModelInfo)
		}
		...
		if (protoConfig.actModeNutstoreModelInfo) {
			config.actModeNutstoreModelInfo = JSON.parse(protoConfig.actModeNutstoreModelInfo)
		}
