...
export class Controller {
	...
	*/
		...
		if (shouldSwitchModel) {
			...
			switch (apiConfiguration.apiProvider) {
				...
				case "cline":
					...
					break
				case "nutstore":
					await updateWorkspaceState(this.context, "previousModeModelId", apiConfiguration.nutstoreModelId)
					await updateWorkspaceState(this.context, "previousModeModelInfo", apiConfiguration.nutstoreModelInfo)
					break
				case "vscode-lm":
			...
			if (
				...
				switch (newApiProvider) {
					...
					case "cline":
						...
						break
					case "nutstore":
						await updateWorkspaceState(this.context, "nutstoreModelId", newModelId)
						await updateWorkspaceState(this.context, "nutstoreModelInfo", newModelInfo)
						break
					case "vscode-lm":
	...
	private async checkNutstoreAccessToken() {
		const provider = await getWorkspaceState(this.context, "apiProvider")
