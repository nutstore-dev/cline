...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	...
	const [
		...
		getGlobalState(context, "planModeNutstoreModelId") as Promise<string | undefined>,
		getGlobalState(context, "planModeNutstoreModelInfo") as Promise<ModelInfo | undefined>,
		...
		getGlobalState(context, "actModeNutstoreModelInfo") as Promise<ModelInfo | undefined>,
		getGlobalState(context, "actModeNutstoreModelId") as Promise<string | undefined>,
