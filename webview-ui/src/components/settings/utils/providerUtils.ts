...
export function normalizeApiConfiguration(
	...
	switch (provider) {
		...
		case "nutstore":
			const nutstoreModelId =
				currentMode === "plan" ? apiConfiguration?.planModeNutstoreModelId : apiConfiguration?.actModeNutstoreModelId
			const nutstoreModelInfo =
				currentMode === "plan" ? apiConfiguration?.planModeNutstoreModelInfo : apiConfiguration?.actModeNutstoreModelInfo
			return {
				selectedProvider: provider,
				selectedModelId: nutstoreModelId || nutstoreDefaultModelId,
				selectedModelInfo: nutstoreModelInfo || nutstoreDefaultModelInfo,
			}
		case "requesty":
...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	...
	return {
		...
		nutstoreModelInfo:
			mode === "plan" ? apiConfiguration.planModeNutstoreModelInfo : apiConfiguration.actModeNutstoreModelInfo,
		requestyModelInfo:
...
export async function syncModeConfigurations(
	...
	switch (apiProvider) {
		...
		case "nutstore":
			updates.planModeNutstoreModelId = sourceFields.nutstoreModelId
			updates.actModeNutstoreModelId = sourceFields.nutstoreModelId
			updates.planModeNutstoreModelInfo = sourceFields.nutstoreModelInfo
			updates.actModeNutstoreModelInfo = sourceFields.nutstoreModelInfo
			break
