	...
	*/
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.openWalkthrough", async () => {
			await vscode.commands.executeCommand("workbench.action.openWalkthrough", "jianguoyun.cline#ClineWalkthrough")
...
function setupHostProvider(context: ExtensionContext) {
	...
	const getCallbackUri = async () => `${vscode.env.uriScheme || "vscode"}://jianguoyun.cline`
