...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeNutstoreModelInfo: convertModelInfoToProtoOpenRouter(config.planModeNutstoreModelInfo),
		...
		actModeNutstoreModelInfo: convertModelInfoToProtoOpenRouter(config.actModeNutstoreModelInfo),
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		planModeNutstoreModelInfo: convertProtoToModelInfo(protoConfig.planModeNutstoreModelInfo),
		...
		actModeNutstoreModelInfo: convertProtoToModelInfo(protoConfig.actModeNutstoreModelInfo),
